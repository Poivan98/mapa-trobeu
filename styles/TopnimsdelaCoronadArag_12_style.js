...
var style_TopnimsdelaCoronadArag_12 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("Nom_mapa") !== null && resolution > 0 && resolution < 560) {
            labelText = String(feature.get("Nom_mapa"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 3.6 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(247,247,247,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(83,83,83,1.0)'})}),
